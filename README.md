...
이 저장소는 비공식 학습용 프로젝트이며, 리눅스마스터 시험 주관 기관과 관련이 없습니다. 실제 기출문제, 유출 문제, 특정 교재나 강의자료의 원문을 복제해 제공하는 목적이 아니며, 리눅스 기본 개념을 바탕으로 자체 제작한 연습 문제와 요약 자료를 제공합니다.
...
개발 서버가 실행 중인 내 PC에서는 터미널에 표시되는 `Local` 주소로 접속해 확인할 수 있습니다. 이 주소는 내 PC 전용 개발 주소라서 PowerShell을 닫거나 PC를 끄면 접속되지 않고, 다른 사람에게 공유할 주소로는 사용할 수 없습니다.
