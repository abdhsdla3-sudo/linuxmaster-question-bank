...
export default function WrongNoteQuestionCard({
  question,
  index,
  total,
  selected,
        ...
        {question.choices.map((choice, choiceIndex) => {
          ...
          return (
            <button
              ...
              className={`flex min-h-12 w-full items-start gap-3 rounded-md border px-4 py-3 text-left text-sm font-medium transition ${resultClass}`}
            >
